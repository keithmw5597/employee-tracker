...
function prompt() {
    ...
    .then(answers => {
        ...
        if(userPrompt === 'View all departments'){
            viewAllDepts();
        } else if (userPrompt === 'View all roles'){
            viewRoles();
        } else if (userPrompt === 'View all employees'){
            viewEmployees();
        } else if (userPrompt === 'Add a department'){
            addDept();
        } else if (userPrompt === 'Add a role'){
            addRole();
        } else if (userPrompt === 'Add an employee'){
            addEmployee();
        } else if (userPrompt === 'Update an employee role'){
            updateEmployeeRole();
        } else if (userPrompt === "Update employee's manager"){
            updateEmployeeManager();
        } else if (userPrompt === 'EXIT'){
            exit();
        } else if (userPrompt === 'Delete an employee'){
            deleteEmployee();
        } else if (userPrompt === 'Delete a department'){
            deleteDept();
        } else if (userPrompt === 'Delete a role'){
            deleteRole();
        } else{
            return;
        }
